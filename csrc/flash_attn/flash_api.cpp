...
void set_params_fprop_sparse(Flash_fwd_params &params,
                            // sizes
                            const size_t b,
                            const size_t seqlen_q,
                            const size_t seqlen_k,
...
void set_params_alibi(Flash_fwd_params &params, const std::optional<at::Tensor> &alibi_slopes_, int batch_size, int num_heads){
