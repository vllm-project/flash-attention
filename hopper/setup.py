...
if not SKIP_CUDA_BUILD:
    ...
    feature_args = (
        ...
        + (["-DFLASHATTENTION_DISABLE_HDIM40"] if DISABLE_HDIM40 else [])
        + (["-DFLASHATTENTION_DISABLE_HDIM64"] if DISABLE_HDIM64 else [])
        + (["-DFLASHATTENTION_DISABLE_HDIM72"] if DISABLE_HDIM72 else [])
        + (["-DFLASHATTENTION_DISABLE_HDIM80"] if DISABLE_HDIM80 else [])
